<!-- Keep this short. The Vercel preview is the real review surface. -->
...
<!-- Link the request, the client message, or the reason. -->

## Review checklist

- [ ] Checked the **Vercel preview** deploy (not just the diff)
...
<!-- Anything to look at specifically, or "none". -->
